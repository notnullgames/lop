...
function pntr_app_emscripten_set_app(app) { Module.pntr_app = app; }
...
function pntr_app_emscripten_set_icon(app,width,height,encodedData) { const text = UTF8ToString(encodedData); const link = document.createElement('link'); link.id = 'pntr-app-set-icon'; link.rel = 'icon'; link.type = 'image/png'; link.sizes = width + 'x' + height; link.href = 'data:image/png;base64,' + text; const oldLink = document.getElementById('pntr-app-set-icon'); if (oldLink) { document.head.removeChild(oldLink); } document.head.appendChild(link); }

// Imports from the Wasm binary.
var __sargs_add_kvp = Module['__sargs_add_kvp'] = makeInvalidEarlyAccess('__sargs_add_kvp');
var _free = makeInvalidEarlyAccess('_free');
var _pntr_app_emscripten_file_dropped = Module['_pntr_app_emscripten_file_dropped'] = makeInvalidEarlyAccess('_pntr_app_emscripten_file_dropped');
var _pntr_app_emscripten_load_memory = Module['_pntr_app_emscripten_load_memory'] = makeInvalidEarlyAccess('_pntr_app_emscripten_load_memory');
var _malloc = makeInvalidEarlyAccess('_malloc');
var _pntr_app_emscripten_unload_memory = Module['_pntr_app_emscripten_unload_memory'] = makeInvalidEarlyAccess('_pntr_app_emscripten_unload_memory');
var _pntr_app_emscripten_load_state = Module['_pntr_app_emscripten_load_state'] = makeInvalidEarlyAccess('_pntr_app_emscripten_load_state');
var _pntr_app_emscripten_save_state = Module['_pntr_app_emscripten_save_state'] = makeInvalidEarlyAccess('_pntr_app_emscripten_save_state');
...
function assignWasmExports(wasmExports) {
  Module['__sargs_add_kvp'] = __sargs_add_kvp = createExportWrapper('_sargs_add_kvp', 2);
  _free = createExportWrapper('free', 1);
  Module['_pntr_app_emscripten_file_dropped'] = _pntr_app_emscripten_file_dropped = createExportWrapper('pntr_app_emscripten_file_dropped', 4);
  Module['_pntr_app_emscripten_load_memory'] = _pntr_app_emscripten_load_memory = createExportWrapper('pntr_app_emscripten_load_memory', 1);
  _malloc = createExportWrapper('malloc', 1);
  Module['_pntr_app_emscripten_unload_memory'] = _pntr_app_emscripten_unload_memory = createExportWrapper('pntr_app_emscripten_unload_memory', 1);
  Module['_pntr_app_emscripten_load_state'] = _pntr_app_emscripten_load_state = createExportWrapper('pntr_app_emscripten_load_state', 1);
  Module['_pntr_app_emscripten_save_state'] = _pntr_app_emscripten_save_state = createExportWrapper('pntr_app_emscripten_save_state', 1);
